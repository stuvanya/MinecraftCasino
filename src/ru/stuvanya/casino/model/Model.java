...
public class Model {
	...
	private Map<Integer, Material> items = new HashMap<Integer, Material>() {{
		put(0, Material.DIRT);
		put(1, Material.SAND);
	...
	private int[][] curMatrix = new int[rows][cols];
	private Material[][] curItemMatrix = new Material[rows][cols];
	private int win = 0;

	public int getNewSpin() {
		win = 0;
